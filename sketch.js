...
//////////////////////////
    ...
    archerupimg=loadAnimation("archer4.0.png", "archer4.0b.png")
...
///////////////////////
    archerimg.playing=true;
    archerleftimg.playing=true;
    archerupimg.playing=true;
...
function setup() {
   ...
   //////////////////////
    archer.addAnimation("righto",archerimg);
    archer.addAnimation("lefto",archerleftimg);
    archer.addAnimation("upo",archerupimg);

    archer.changeAnimation("lefto")
